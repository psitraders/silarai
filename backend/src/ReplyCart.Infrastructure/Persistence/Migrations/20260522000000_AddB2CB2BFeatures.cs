...
{
    /// <inheritdoc />
    public partial class AddB2CB2BFeatures : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // ── B2B fields on Products ──────────────────────────────────────────
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsB2BCustomer     = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    IsB2BApproved     = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StorefrontCustomers_TenantId_Email",
                table: "StorefrontCustomers",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "ProductWholesaleTiers");
            migrationBuilder.DropTable(name: "StorefrontWishlistItems");
            migrationBuilder.DropTable(name: "StorefrontCustomers");

            migrationBuilder.DropColumn(name: "IsB2BOnly",        table: "Products");
            migrationBuilder.DropColumn(name: "MinOrderQuantity", table: "Products");
            migrationBuilder.DropColumn(name: "MaxOrderQuantity", table: "Products");
        }
    }
}
