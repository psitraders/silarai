      ...
      <section className="bg-white py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="bg-teal-50 border border-teal-100 rounded-xl p-5 mb-10 text-sm text-teal-800 leading-relaxed">
            <strong>Please read these terms carefully.</strong> By creating an account or using ReplyCart, you agree to these Terms of Service.
          </div>

          <Section title="1. Acceptance of terms">
            <p>
              These Terms of Service ("Terms") form a legally binding agreement between you ("User", "Seller") and ReplyCart ("we", "us", "our"). By accessing or using the ReplyCart platform at replycart.app or any associated services, you confirm that you have read, understood, and agree to be bound by these Terms.
            </p>
            <p>If you do not agree, please do not use our services.</p>
          </Section>

          <Section title="2. Description of service">
            <p>ReplyCart provides a SaaS platform that enables small businesses to:</p>
          ...
          <Section title="3. Account registration">
            <p>To use ReplyCart, you must create an account. You agree to:</p>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <Section title="4. Acceptable use">
            <p>You agree not to use ReplyCart to:</p>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <Section title="7. Your content">
            <p>You retain ownership of all content you upload to ReplyCart — including product images, descriptions, and customer data.</p>
            <p>By uploading content, you grant ReplyCart a limited, non-exclusive licence to host, display, and transmit that content solely for the purpose of operating the platform.</p>
          ...
          <Section title="8. Our intellectual property">
            <p>ReplyCart and all associated software, design, trademarks, and content are the property of ReplyCart. You may not copy, reproduce, distribute, or create derivative works from any part of our platform without our express written permission.</p>
          </Section>

          <Section title="9. Third-party services">
            <p>ReplyCart integrates with third-party services including Razorpay, WhatsApp Business API, Cloudinary, and OpenAI. Your use of these services is subject to their respective terms and privacy policies. We are not responsible for the actions or availability of these services.</p>
          </Section>

          <Section title="10. Limitation of liability">
            <p>To the maximum extent permitted by law, ReplyCart shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, revenue, data, or goodwill.</p>
          ...
          <Section title="11. Disclaimer of warranties">
            <p>ReplyCart is provided "as is" and "as available" without warranties of any kind, express or implied. We do not warrant that the service will be uninterrupted, error-free, or free of viruses or other harmful components.</p>
          </Section>

          <Section title="12. Indemnification">
            <p>You agree to indemnify and hold harmless ReplyCart and its officers, directors, and employees from any claims, damages, losses, or expenses (including legal fees) arising from your use of the platform, violation of these Terms, or infringement of any third-party rights.</p>
          </Section>

          <Section title="13. Termination">
            <p>You may terminate your account at any time by contacting us at support@replycart.app.</p>
          ...
          <Section title="15. Changes to these terms">
            <p>We may update these Terms from time to time. We will notify you of material changes via email or in-app notice at least 14 days before the changes take effect. Continued use of ReplyCart after changes take effect constitutes acceptance of the new Terms.</p>
          </Section>
